...
export default function AIParseBillPage() {
  ...
  const handleParseBill = async () => {
    ...
    try {
      ...
      console.log('[AI Parse] Uploading file:', file.name, 'type:', file.type, 'size:', file.size)
      ...
      console.log('[AI Parse] Response status:', res.status, res.statusText)

      if (res.ok) {
        const result = await res.json()
        // DEBUG: log parsed result
        console.log('[AI Parse] Parsed result:', result)
  ...
  const handleConfirmAndSave = async () => {
    ...
    try {
      ...
      // Store parsed data in sessionStorage for the create page to use
      ...
      sessionStorage.setItem('parsedInvoiceData', JSON.stringify(parsedInvoiceData))
      
      // Redirect to create page
      router.push('/purchase-invoices/create')
    } catch (err) {
      ...
      <div className="max-w-7xl space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">AI Bill Parser</h1>
          </div>
        </div>
                ...
                <label htmlFor="bill-image" className="cursor-pointer">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="text-center">
                      <p className="text-sm font-medium text-gray-900">Click to upload bill image or PDF</p>
